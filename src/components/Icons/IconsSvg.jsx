import styles from "../Leader/Leader.module.css";

export function IconModeYes() {
  return (
    <svg
...
export function IconSuperpowerYes() {
  return (
    <svg
      className={styles.achievements_icon}
      width="22"
...
export function IconSuperpowerNo() {
  return (
    <svg
      className={styles.achievements_icon}
      width="22"
